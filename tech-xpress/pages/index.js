    ...
    return (
        <Layout>
            <div className="flex flex-col">
                ...
                <div className="pic-outline min-w-full my-10 min-h-screen rounded-md px-2 py-4">
                    <span className="float mb-4 bg-bgGray font-bold flex items-center w-auto flex-col rounded-md">
                        <h1 className="text-emerald-900 font-bold">Pending orders</h1>
                        <h2 className="text-4xl">{orders.length}</h2>
                        <h3 className="text-emerald-600">Still in progress</h3>
                    </span>
                    <span className="float mb-4 bg-bgGray font-bold flex items-center w-auto flex-col rounded-md">
                        <h1 className="text-emerald-900 font-bold">Product Categories</h1>
                        <h2 className="text-4xl">{Categories.length}</h2>
                        <h3 className="text-emerald-600">Variety is our Priority</h3>
                    </span>
                    <span className="float mb-4 bg-bgGray font-bold flex items-center w-auto flex-col rounded-md">
                        <h1 className="text-emerald-900 font-bold">Products available</h1>
                        <h2 className="text-4xl">{Products.length}</h2>
                        <h3 className="text-emerald-600">Commodities in stock</h3>
                    </span>
                </div>
            </div>
        </Layout>
